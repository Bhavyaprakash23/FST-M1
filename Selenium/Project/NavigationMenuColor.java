...
public class NavigationMenuColor {
    ...
    public String getNavigationMenuColor() {

        // Navigation menu bar
        WebElement navMenu = wait.until(
                ExpectedConditions.visibilityOfElementLocated(
                        By.cssSelector("div.navbar.navbar-inverse")));

        // Get background color
        return navMenu.getCssValue("background-color");
    }
